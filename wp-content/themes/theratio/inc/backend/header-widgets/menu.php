	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .main-navigation ul > li > a:hover, {{WRAPPER}} .main-navigation ul > li.menu-item-has-children > a:hover:after' => 'color: {{VALUE}};',
					'{{WRAPPER}} .main-navigation > ul > li > a:hover:before' => 'background-color: {{VALUE}};',
...
Plugin::instance()->widgets_manager->register_widget_type( new Theratio_Menu() );