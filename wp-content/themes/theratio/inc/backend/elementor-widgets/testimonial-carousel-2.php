...
class Theratio_Testimonials_2 extends Widget_Base{
	...
	protected function render() {
		...
		<div class="ot-testimonials <?php echo $settings['version_style']; ?>">						
			<div class="testimonial-inner ot-testimonials-slider-s2 <?php if( $arrows ){ echo 'arrow-bot'; } ?> swiper-container" <?php if( is_rtl() ){ echo'dir="rtl"'; }?> data-show="<?php echo $settings['tshow']; ?>" data-show-tablet="<?php echo esc_attr( $settings['tshow_tablet'] ); ?>" data-show-mobile="<?php echo esc_attr( $settings['tshow_mobile'] ); ?>" data-scroll="<?php echo $settings['tscroll']; ?>" data-scroll-tablet="<?php echo $settings['tscroll_tablet']; ?>" data-scroll-mobile="<?php echo $settings['tscroll_mobile']; ?>" data-effect="<?php echo $settings['slide_effect']; ?>">
