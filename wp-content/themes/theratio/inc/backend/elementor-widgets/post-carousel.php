...
class Theratio_Post_Carousel extends Widget_Base{
	...
	protected function render() {
		...
		<div class="blog-slider swiper-container <?php echo $settings['version_style']; ?>" <?php if( is_rtl() ){ echo'dir="rtl"'; }?> data-show="<?php echo $settings['tshow']; ?>" data-show-tablet="<?php echo esc_attr( $settings['tshow_tablet'] ); ?>" data-show-mobile="<?php echo esc_attr( $settings['tshow_mobile'] ); ?>" data-scroll="<?php echo $settings['tscroll']; ?>" data-scroll-tablet="<?php echo $settings['tscroll_tablet']; ?>" data-scroll-mobile="<?php echo $settings['tscroll_mobile']; ?>" data-gaps="<?php echo esc_attr( $settings['post_spacing']['size'] ); ?>" data-gaps-tablet="<?php echo esc_attr( $settings['post_spacing_tablet']['size'] ); ?>" data-gaps-mobile="<?php echo $settings['post_spacing_mobile']['size']; ?>">
